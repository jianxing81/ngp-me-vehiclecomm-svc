...
public class UpdateStop extends AbstractJobEvent {
  ...
  public void handleJobEvent(EsbJob esbJob, String ivdJobEventTopic) {
    ...
    var byteDataRepresentation =
        byteToBeanConverter.updateStopEventConverter(esbJob.getIvdMessageRequest().getMessage());
    ...
    callVehicleSvcToUpdateVehicleState(esbJob, VehicleEvent.ARRIVE_INTERMEDIATE);
  ...
  public IvdMessageEnum jobEventType() {
    return IvdMessageEnum.UPDATE_STOP;
  }
}
