...
/**
 * For VehicleComm requirement "4.2.1.15.25 Auto Accept Job Confirmation Ack Event Use Case Design
 * Document"
 *
 * @see <a
 *     href="https://comfortdelgrotaxi.atlassian.net/wiki/spaces/NGP/pages/1263534311/4.2.1.15.25+Auto+Accept+Job+Confirmation+Ack+Event+Use+Case+Design+Document">4.2.1.15.25
 *     Auto Accept Job Confirmation Ack Event Use Case Design Document</a>
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class AutoAcceptJobConfirmationAcknowledge extends AbstractJobEvent {
  ...
  public void handleJobEvent(EsbJob esbJob, String ivdJobEventTopic) {
    ...
    var byteDataRepresentation =
        byteToBeanConverter.autoAcceptJobConfirmationAckEvent(
    ...
    callJobDispatchSvc(esbJob, DriverAction.CONFIRM_AUTOACCEPT_ACK);
  ...
  public IvdMessageEnum jobEventType() {
    return IvdMessageEnum.AUTO_ACCEPT_JOB_CONF_ACK;
  }
}
