...
@Slf4j
public class MeterOffStreethailJobConverter implements GenericByteToBeanStrategy {
  ...
  public GenericByteData convert(String hexString) {
    return genericByteToBeanMapper.byteDataRepresentationToGenericByteData(
        byteToBeanConverter.meterOffStreetHailJobEvent(hexString));
  }

  @Override
  public ByteToBeanEvent getEventId() {
    return ByteToBeanEvent.METER_OFF_STREETHAIL_JOB;
  }
}
