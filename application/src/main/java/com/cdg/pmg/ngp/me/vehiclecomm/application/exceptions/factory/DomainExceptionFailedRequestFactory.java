...
/** Class for creating failed request objects specific to DomainException. */
@Component
public class DomainExceptionFailedRequestFactory implements FailedRequestFactory {

  /**
   * Creates a failed request object for DomainException.
   *
