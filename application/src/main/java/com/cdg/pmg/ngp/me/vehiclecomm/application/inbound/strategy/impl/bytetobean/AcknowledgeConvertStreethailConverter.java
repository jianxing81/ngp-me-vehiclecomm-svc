...
@Slf4j
public class AcknowledgeConvertStreethailConverter implements GenericByteToBeanStrategy {
  ...
  public GenericByteData convert(String hexString) {
    return genericByteToBeanMapper.byteDataRepresentationToGenericByteData(
        byteToBeanConverter.acknowledgeConvertStreetHailEvent(hexString));
  }

  @Override
  public ByteToBeanEvent getEventId() {
    return ByteToBeanEvent.ACKNOWLEDGE_CONVERT_STREETHAIL;
  }
}
