...
/** Class for creating failed request objects specific to ConstraintException. */
@Component
public class ConstraintExceptionFailedRequestFactory implements FailedRequestFactory {
  /**
   * Creates a failed request object for ConstraintException.
   *
