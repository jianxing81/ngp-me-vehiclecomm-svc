...
/**
 * For VehicleComm requirement "4.2.1.15.5 Acknowledge Job Modification Event Use Case Design
 * Document"
 *
 * @see <a
 *     href="https://comfortdelgrotaxi.atlassian.net/wiki/spaces/NGP/pages/1260717105/4.2.1.15.5+Acknowledge+Job+Modification+Event+Use+Case+Design+Document">4.2.1.15.5
 *     Acknowledge Job Modification Event Use Case Design Document</a>
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class JobModification extends AbstractJobEvent {
  ...
  public void handleJobEvent(EsbJob esbJob, String ivdJobEventTopic) {
    ...
    var byteDataRepresentation =
        byteToBeanConverter.jobModificationConverter(esbJob.getIvdMessageRequest().getMessage());
    ...
    callJobDispatchSvc(esbJob, DriverAction.MODIFY_ACK);
  ...
  public IvdMessageEnum jobEventType() {
    return IvdMessageEnum.JOB_MODIFICATION;
  }
}
