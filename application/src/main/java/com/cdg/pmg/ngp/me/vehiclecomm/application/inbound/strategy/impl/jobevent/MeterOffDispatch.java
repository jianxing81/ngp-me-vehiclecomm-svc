...
public class MeterOffDispatch extends AbstractJobEvent {
  ...
  public void handleJobEvent(EsbJob esbJob, String ivdJobEventTopic) {
    ...
    var byteDataRepresentation =
        byteToBeanConverter.meterOffDispatchJobEvent(esbJob.getIvdMessageRequest().getMessage());
  ...
  public IvdMessageEnum jobEventType() {
    return IvdMessageEnum.METER_OFF_DISPATCH;
  }
}
