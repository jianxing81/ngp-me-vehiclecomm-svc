...
/**
 * For VehicleComm requirement "4.2.1.15.9 Call Out Event Use Case Design Document"
 *
 * @see <a
 *     href="https://comfortdelgrotaxi.atlassian.net/wiki/spaces/NGP/pages/1269105425/4.2.1.15.9+Call+Out+Event+Use+Case+Design+Document">4.2.1.15.9
 *     Call Out Event Use Case Design Document</a>
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class Callout extends AbstractJobEvent {
  ...
  public void handleJobEvent(EsbJob esbJob, String ivdJobEventTopic) {
    ...
    var byteDataRepresentation =
        byteToBeanConverter.callOutEvent(esbJob.getIvdMessageRequest().getMessage());
    ...
    callJobDispatchSvc(esbJob, DriverAction.CALL_OUT);
  ...
  public IvdMessageEnum jobEventType() {
    return IvdMessageEnum.CALL_OUT;
  }
}
