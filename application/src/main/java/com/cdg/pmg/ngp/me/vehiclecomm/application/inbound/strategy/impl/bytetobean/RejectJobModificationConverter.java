...
@Slf4j
public class RejectJobModificationConverter implements GenericByteToBeanStrategy {
  ...
  public GenericByteData convert(String hexString) {
    return genericByteToBeanMapper.byteDataRepresentationToGenericByteData(
        byteToBeanConverter.rejectJobModificationConverter(hexString));
  }

  @Override
  public ByteToBeanEvent getEventId() {
    return ByteToBeanEvent.REJECT_JOB_MODIFICATION;
  }
}
