...
/**
 * For VehicleComm requirement "4.2.1.15.65 Vehicle Comm Notify Static GPS event Use Case Design
 * Document"
 *
 * @see <a
 *     href="https://comfortdelgrotaxi.atlassian.net/wiki/spaces/NGP/pages/1361609227/4.2.1.15.65+Vehicle+Comm+Notify+Static+GPS+event+Use+Case+Design+Document">4.2.1.15.65
 *     Vehicle Comm Notify Static GPS event Use Case Design Document</a>
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class NotifyStaticGps extends AbstractVehicleEvent {
  ...
  public void handleVehicleEvent(EsbVehicle esbVehicle, String ivdVehicleEventTopic) {
    ...
    var byteDataRepresentation =
        byteToBeanConverter.notifyStaticGpsConverter(
    ...
    vehicleCommDomainService.setVehicleEventType(esbVehicle, VehicleEvent.NOTIFY_STATIC_GPS);
  ...
  public IvdVehicleEventEnum vehicleEventType() {
    return IvdVehicleEventEnum.NOTIFY_STATIC_GPS;
  }
}
