...
/**
 * For VehicleComm requirement "4.2.1.15.1 Job Accept Event Use Case Design Document"
 *
 * @see <a
 *     href="https://comfortdelgrotaxi.atlassian.net/wiki/spaces/NGP/pages/1259601965/4.2.1.15.1+Job+Accept+Event+Use+Case+Design+Document">4.2.1.15.1
 *     Job Accept Event Use Case Design Document</a>
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class JobAccept extends AbstractJobEvent {
  ...
  public void handleJobEvent(EsbJob esbJob, String ivdJobEventTopic) {
    ...
    var byteDataRepresentation =
        byteToBeanConverter.jobAcceptConverter(esbJob.getIvdMessageRequest().getMessage());
    ...
    callJobDispatchSvc(esbJob, DriverAction.ACCEPT);
  ...
  public IvdMessageEnum jobEventType() {
    return IvdMessageEnum.JOB_ACCEPT;
  }
}
