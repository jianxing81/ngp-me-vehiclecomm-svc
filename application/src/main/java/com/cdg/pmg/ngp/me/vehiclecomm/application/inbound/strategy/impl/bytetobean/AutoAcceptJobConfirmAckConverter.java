...
@Slf4j
public class AutoAcceptJobConfirmAckConverter implements GenericByteToBeanStrategy {
  ...
  public GenericByteData convert(String hexString) {
    return genericByteToBeanMapper.byteDataRepresentationToGenericByteData(
        byteToBeanConverter.autoAcceptJobConfirmationAckEvent(hexString));
  }

  @Override
  public ByteToBeanEvent getEventId() {
    return ByteToBeanEvent.AUTO_ACCEPT_JOB_CONF_ACK;
  }
}
