...
/** Class for creating failed request objects specific to IvdConversionException. */
@Component
public class IvdConversionExceptionFailedRequestFactory implements FailedRequestFactory {

  /**
   * Creates a failed request object for IvdConversionException.
   *
