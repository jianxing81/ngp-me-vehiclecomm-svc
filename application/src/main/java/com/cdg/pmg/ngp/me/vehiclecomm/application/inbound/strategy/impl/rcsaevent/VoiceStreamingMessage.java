...
public class VoiceStreamingMessage extends AbstractRcsaEvent {
  ...
  public void handleRcsaEvent(Rcsa rcsaEvent, String rcsaEventTopic) {
    ...
    var byteDataRepresentation =
        byteToBeanConverter.voiceStreamConverter(rcsaEvent.getRcsaMessageRequest().getMessage());
    ...
    vehicleCommDomainService.setRcsaEventType(rcsaEvent, RcsaEvents.VOICE_STREAMING_MESSAGE);
  ...
  public IvdMessageEnum ivdMessageEnum() {
    return IvdMessageEnum.VOICE_STREAMING_MESSAGE;
  }
}
