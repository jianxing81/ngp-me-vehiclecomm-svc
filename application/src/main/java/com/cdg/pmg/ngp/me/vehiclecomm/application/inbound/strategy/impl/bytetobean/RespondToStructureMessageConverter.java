...
@Slf4j
public class RespondToStructureMessageConverter implements GenericByteToBeanStrategy {
  ...
  public GenericByteData convert(String hexString) {
    return genericByteToBeanMapper.byteDataRepresentationToGenericByteData(
        byteToBeanConverter.respondToStructureConverter(hexString));
  }

  @Override
  public ByteToBeanEvent getEventId() {
    return ByteToBeanEvent.RESPOND_TO_STRUCTURE_MESSAGE;
  }
}
