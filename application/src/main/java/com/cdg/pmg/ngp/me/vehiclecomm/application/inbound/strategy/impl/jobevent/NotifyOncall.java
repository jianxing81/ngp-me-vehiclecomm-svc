...
public class NotifyOncall extends AbstractJobEvent {
  ...
  public void handleJobEvent(EsbJob esbJob, String ivdJobEventTopic) {
    ...
    var byteDataRepresentation =
        byteToBeanConverter.notifyOnCallEventConverter(esbJob.getIvdMessageRequest().getMessage());
    ...
    callVehicleSvcToUpdateVehicleState(esbJob, VehicleEvent.NOTIFY_ONCALL);
  ...
  public IvdMessageEnum jobEventType() {
    return IvdMessageEnum.NOTIFY_ONCALL;
  }
}
