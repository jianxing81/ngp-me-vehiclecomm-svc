...
public class MeterOnDispatch extends AbstractJobEvent {
  ...
  public void handleJobEvent(EsbJob esbJob, String ivdJobEventTopic) {
    ...
    var byteDataRepresentation =
        byteToBeanConverter.meterOnDispatchConverter(esbJob.getIvdMessageRequest().getMessage());
  ...
  public IvdMessageEnum jobEventType() {
    return IvdMessageEnum.METER_ON_DISPATCH;
  }
}
