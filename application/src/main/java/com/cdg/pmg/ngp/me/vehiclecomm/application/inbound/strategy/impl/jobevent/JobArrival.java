...
/**
 * For VehicleComm requirement "4.2.1.15.10 Arrival Event Use Case Design Document"
 *
 * @see <a
 *     href="https://comfortdelgrotaxi.atlassian.net/wiki/spaces/NGP/pages/1261437414/4.2.1.15.10+Arrival+Event+Use+Case+Design+Document">4.2.1.15.10
 *     Arrival Event Use Case Design Document</a>
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class JobArrival extends AbstractJobEvent {
  ...
  public void handleJobEvent(EsbJob esbJob, String ivdJobEventTopic) {
    ...
    var byteDataRepresentation =
        byteToBeanConverter.arrivalEventConverter(esbJob.getIvdMessageRequest().getMessage());
    ...
    callVehicleSvcToUpdateVehicleState(esbJob, VehicleEvent.ARRIVE_PICKUP);
