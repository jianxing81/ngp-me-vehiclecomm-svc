...
@Slf4j
public class DriverPerformanceRequestConverter implements GenericByteToBeanStrategy {
  ...
  public GenericByteData convert(String hexString) {
    return genericByteToBeanMapper.byteDataRepresentationToGenericByteData(
        byteToBeanConverter.driverPerformanceRequestConverter(hexString));
  }

  @Override
  public ByteToBeanEvent getEventId() {
    return ByteToBeanEvent.DRIVER_PERFORMANCE_REQUEST;
  }
}
