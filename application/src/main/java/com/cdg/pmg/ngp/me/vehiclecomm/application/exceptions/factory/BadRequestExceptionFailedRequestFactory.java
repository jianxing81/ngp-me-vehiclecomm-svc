...
/** Class for creating failed request objects specific to BadRequestException. */
@Component
public class BadRequestExceptionFailedRequestFactory implements FailedRequestFactory {

  /**
   * Creates a failed request object for BadRequestException.
   *
