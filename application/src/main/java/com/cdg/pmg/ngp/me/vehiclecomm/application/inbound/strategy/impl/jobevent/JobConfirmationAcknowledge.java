...
/**
 * For VehicleComm requirement "4.2.1.15.2 Job Confirmation Acknowledge Event Use Case Design
 * Document"
 *
 * @see <a
 *     href="https://comfortdelgrotaxi.atlassian.net/wiki/spaces/NGP/pages/1261437283/4.2.1.15.2+Job+Confirmation+Acknowledge+Event+Use+Case+Design+Document">4.2.1.15.2
 *     Job Confirmation Acknowledge Event Use Case Design Document</a>
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class JobConfirmationAcknowledge extends AbstractJobEvent {
  ...
  public void handleJobEvent(EsbJob esbJob, String ivdJobEventTopic) {
    ...
    var byteDataRepresentation =
        byteToBeanConverter.jobConfirmationAcknowledgeConverter(
    ...
    callJobDispatchSvc(esbJob, DriverAction.CONFIRM_ACK);
  ...
  public IvdMessageEnum jobEventType() {
    return IvdMessageEnum.JOB_CONFIRM_ACKNOWLEDGE;
  }
}
