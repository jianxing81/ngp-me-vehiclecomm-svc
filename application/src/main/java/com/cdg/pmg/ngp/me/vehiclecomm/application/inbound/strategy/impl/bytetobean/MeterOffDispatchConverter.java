...
@Slf4j
public class MeterOffDispatchConverter implements GenericByteToBeanStrategy {
  ...
  public GenericByteData convert(String hexString) {
    return genericByteToBeanMapper.byteDataRepresentationToGenericByteData(
        byteToBeanConverter.meterOffDispatchJobEvent(hexString));
  }

  @Override
  public ByteToBeanEvent getEventId() {
    return ByteToBeanEvent.METER_OFF_DISPATCH;
  }
}
