...
/**
 * For VehicleComm requirement "4.2.1.15.32 Update STC Event Use Case Design Document"
 *
 * @see <a
 *     href="https://comfortdelgrotaxi.atlassian.net/wiki/spaces/NGP/pages/1272153037/4.2.1.15.32+Update+STC+Event+Use+Case+Design+Document">4.2.1.15.32
 *     Update STC Event Use Case Design Document</a>
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class UpdateStcEvent extends AbstractVehicleEvent {
  ...
  public void handleVehicleEvent(EsbVehicle esbVehicle, String ivdVehicleEventTopic) {
    ...
    var byteDataRepresentation =
        byteToBeanConverter.updateStcConverter(
    ...
    vehicleCommDomainService.setVehicleEventType(esbVehicle, VehicleEvent.STC);
  ...
  public IvdVehicleEventEnum vehicleEventType() {
    return IvdVehicleEventEnum.UPDATE_STC;
  }
}
