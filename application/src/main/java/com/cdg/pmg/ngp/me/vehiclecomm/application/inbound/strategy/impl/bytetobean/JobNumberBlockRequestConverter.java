...
@Slf4j
public class JobNumberBlockRequestConverter implements GenericByteToBeanStrategy {
  ...
  public GenericByteData convert(String hexString) {
    return genericByteToBeanMapper.byteDataRepresentationToGenericByteData(
        byteToBeanConverter.jobNumberBlockRequestEventConverter(hexString));
  }

  @Override
  public ByteToBeanEvent getEventId() {
    return ByteToBeanEvent.JOB_NUMBER_BLOCK_REQUEST;
  }
}
