...
/**
 * For VehicleComm requirement "4.2.1.15.64 Vehicle Comm Expressway Status Update event Use Case
 * Design Document"
 *
 * @see <a
 *     href="https://comfortdelgrotaxi.atlassian.net/wiki/spaces/NGP/pages/1361674799/4.2.1.15.64+Vehicle+Comm+Expressway+Status+Update+event+Use+Case+Design+Document">4.2.1.15.64
 *     Vehicle Comm Expressway Status Update event Use Case Design Document</a>
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class ExpresswayStatusUpdate extends AbstractVehicleEvent {
  ...
  public void handleVehicleEvent(EsbVehicle esbVehicle, String ivdVehicleEventTopic) {
    ...
    var byteDataRepresentation =
        byteToBeanConverter.expresswayStatusUpdateConverter(
    ...
    vehicleCommDomainService.setVehicleEventType(esbVehicle, VehicleEvent.EXPRESSWAY_STATUS_UPDATE);
  ...
  public IvdVehicleEventEnum vehicleEventType() {
    return IvdVehicleEventEnum.EXPRESSWAY_STATUS_UPDATE;
  }
}
